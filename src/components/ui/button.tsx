  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: 
          "bg-gradient-to-r from-primary via-secondary to-tertiary text-white dark:text-black font-bold shadow-lg hover:shadow-[0_0_40px_hsl(350_70%_65%/_0.3)] hover:-translate-y-1 active:translate-y-0",
        heroOutline:
        ...
        glow:
          "bg-gradient-to-r from-primary to-secondary text-white dark:text-black font-bold shadow-[0_0_30px_hsl(350_70%_65%/_0.3)] hover:shadow-[0_0_50px_hsl(350_70%_65%/_0.5)] hover:-translate-y-1",
        glass:
